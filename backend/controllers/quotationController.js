...
export const createQuotation = async (req, res) => {
  try {
    const {
      ...
      tdsPercentage, tdsAmount, notes, termsAndConditions,
...
export const updateQuotation = async (req, res) => {
  try {
    ...
    if (tdsPercentage !== undefined) quotation.tdsPercentage = Number(tdsPercentage) || 0;
    if (tdsAmount !== undefined) quotation.tdsAmount = Number(tdsAmount) || 0;
    ...
    quotation.grandTotal = Math.round(sub + tax - disc - tds + adj);
